...
public class TestParser {
    ...
    void Should_Pass_If_Output_Is_Same_As_Expected() {
        ...
        String expectedOutPut = "IntermediateRep{intermediateRep=[LineStatement{label=null, instruction=null, directive=null, comment=Comment{; TestImmediate.asm - Test immediate instructions.}, code=[]}, LineStatement{label=null, instruction=null, directive=null, comment=null, code=[]}, LineStatement{label=null, instruction=Instruction{mnemonic=Mnemonic{opCode=112, name=enter.u5}, operand=Operand{operand=0, label='null'}}, directive=null, comment=Comment{; OK, number <u5> [0..31].}, code=[112]}, LineStatement{label=null, instruction=Instruction{mnemonic=Mnemonic{opCode=144, name=ldc.i3}, operand=Operand{operand=1, label='null'}}, directive=null, comment=Comment{; OK, number <i3> [-4..3].}, code=[145]}, LineStatement{label=null, instruction=Instruction{mnemonic=Mnemonic{opCode=152, name=addv.u3}, operand=Operand{operand=6, label='null'}}, directive=null, comment=Comment{; OK, number <u3> [0..7].}, code=[158]}, LineStatement{label=null, instruction=Instruction{mnemonic=Mnemonic{opCode=160, name=ldv.u3}, operand=Operand{operand=3, label='null'}}, directive=null, comment=Comment{; OK, number <u3> [0..7].}, code=[163]}, LineStatement{label=null, instruction=Instruction{mnemonic=Mnemonic{opCode=168, name=stv.u3}, operand=Operand{operand=5, label='null'}}, directive=null, comment=Comment{; OK, number <u3> [0..7].}, code=[173]}, LineStatement{label=null, instruction=null, directive=null, comment=null, code=[]}]}";
