...
public class TestParser {
    ...
    void Should_Pass_If_Output_Is_Same_As_Expected() {
        ...
        String expectedOutPut = "IntermediateRep{intermediateRep=[LineStatement{label=null, instruction=null, directive=null, comment=Comment{; TestImmediate.asm - Test immediate instructions.}, address=0, code=[]}, LineStatement{label=null, instruction=null, directive=null, comment=null, address=0, code=[]}, LineStatement{label=null, instruction=Instruction{mnemonic=Mnemonic{opCode=128, name=enter.u5}, operand=Operand{operand=0, label='null'}}, directive=null, comment=Comment{; OK, number <u5> [0..31].}, address=0, code=[]}, LineStatement{label=null, instruction=Instruction{mnemonic=Mnemonic{opCode=145, name=ldc.i3}, operand=Operand{operand=1, label='null'}}, directive=null, comment=Comment{; OK, number <i3> [-4..3].}, address=0, code=[]}, LineStatement{label=null, instruction=Instruction{mnemonic=Mnemonic{opCode=158, name=addv.u3}, operand=Operand{operand=6, label='null'}}, directive=null, comment=Comment{; OK, number <u3> [0..7].}, address=0, code=[]}, LineStatement{label=null, instruction=Instruction{mnemonic=Mnemonic{opCode=163, name=ldv.u3}, operand=Operand{operand=3, label='null'}}, directive=null, comment=Comment{; OK, number <u3> [0..7].}, address=0, code=[]}, LineStatement{label=null, instruction=Instruction{mnemonic=Mnemonic{opCode=173, name=stv.u3}, operand=Operand{operand=5, label='null'}}, directive=null, comment=Comment{; OK, number <u3> [0..7].}, address=0, code=[]}, LineStatement{label=null, instruction=null, directive=null, comment=null, address=0, code=[]}]}";
